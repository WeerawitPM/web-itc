...
export default function Hero({ data }: Props) {
  ...
  const imageUrl = data.attributes.image?.data?.attributes?.url ? `${process.env.STRAPI_BASE_URL}${data?.attributes?.image?.data?.attributes?.url}` : "/assets/images/not-found.png";
