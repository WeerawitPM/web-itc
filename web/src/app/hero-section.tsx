...
export default function Hero({ data }: Props) {
  ...
  const imageUrl = data?.attributes?.image?.data?.attributes?.url ? `${process.env.NEXT_PUBLIC_STRAPI_BASE_IMAGE}${data?.attributes?.image?.data?.attributes?.url}` : "/assets/images/not-found.png";
